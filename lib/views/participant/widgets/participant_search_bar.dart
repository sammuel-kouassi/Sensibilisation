...
class ParticipantSearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ── Pas de Padding ici — géré par le parent ──
    return Row(
      children: [
        // ── Barre de recherche ──
        Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: hasFilter
                    ? const Color(0xFFFF8000).withValues(alpha: 0.35)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: statut.color.withValues(alpha: 0.25), width: 1),
        ),
        child: Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.tune_rounded,
                    color: Color(0xFFFF8000), size: 18),
              ),
